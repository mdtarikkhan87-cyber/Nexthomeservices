...
import { AdminAuditLogProvider, AdminComplaintsProvider } from "@/lib/admin-client";
...
// Activity tab back to /admin. AdminAuditLogProvider wraps
// AdminComplaintsProvider so resolveComplaint can log through it too.
