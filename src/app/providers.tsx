    ...
    <MotionConfig reducedMotion="user">
      <AuthProvider>
        {/* Inside AuthProvider — the notification feed is scoped to the
            active role, so it needs auth state to exist above it. Same
            reasoning for SocketProvider: the connection is only ever
            established once isAuthenticated is known. */}
        <SocketProvider>
